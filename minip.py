...
veggies=["potato","brinjal","tomato","onion","carrot"]
quantity=[33,10,30,15,25]
S_P=[35,25,20,15,30]
C_P=[31,20,15,5,20]
cart=[]
cart_qty=[]
...
revenue=0
while True:
    print("WLCOME TO VEG MINIPROJECT")
    print("1.Shopkeeper \n2.Customer \n3.Close the shop")
    ...
    if view==1:
        while True:
            ...
            if Owner_id ==814268 and Owner_password=="Hari1040@":
                while True:
                    ...
                    if ch==1:
                        ...
                        print("over all profit",sum(S_P)-sum(C_P))
                        break
        ...
        print("Welcome to  Veggetable Mart")
        ...
        while True:
            ...
            if ch==1:
                ...
                print("veggies",' '*10,"quantity",' '*5,"S_P ")
                for i,j,k in zip(veggies,quantity,S_P):
                    print(i,' '*10,j,' '*10,k)
